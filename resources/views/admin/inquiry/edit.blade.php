@section('title', 'Welox Pharma || Inquiry Edit')
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 p-5">
            ...
            action="{{ route('blog.list.update', $blog->id) }}"
    ...
    <div class="intro-y box p-1">
        ...
        <div class='input-form mb-1 @error('description') has-error @enderror'>
            <label class='form-label'
                ...
                <input type="hidden" id="descriptions_edit" name="description" value="{{ $blog->description }}"/>
            <div id='toolbar-container'></div>
            <div class='editor' id='description' name='description' value='{{ $blog->description }}'>
                {!! $blog->description !!}   
            </div>
            @error('description')
