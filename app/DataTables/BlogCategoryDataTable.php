...
class BlogCategoryDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('name',function (BlogCategory $blogCategory)
            {
                
                return '<a href="' . url('/blog/category/' . $blogCategory->slug) . '" target="_blank">' . $blogCategory->name . '</a>';
                
            })
            ->editColumn('status' , function(BlogCategory $blogCategory){
           
                if ($blogCategory->status == 'A') {
                    
                   $response = '<span class="text-capitalize badge-light-success badge-pill">Active</span>';  // JKDobariya
                }
                else if ($blogCategory->status == 'D') {
                    $response = '<span class="text-capitalize badge-light-secondary badge-pill">Deactive</span>';
                }
                else {
                    $response = "";
                }
   ...
   /**
     ...
     *
     * @param \App\Models\BlogCategoryDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('blogcategorydatatable-table')
