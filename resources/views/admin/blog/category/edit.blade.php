    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-lg-8 mb-4 order-0">
                <div class="card p-4">
                    ...
                    <div class="input-form mb-1  @error('parent_id') has-error @enderror">
                        ...
                        <select name="parent_id" id="parent_id" class="select2 form-select form-control">
                            ...
                            @foreach ($categories as $cat)
                                <option value="{{ $cat->id }}"
                                    @if (old('parent_id')) { selected } @elseif($cat->id == $category->parent_id) selected @endif>
                                    {{ $cat->name }}</option>
                            @endforeach
                        </select>
                        @error('parent_id')
                    ...
                    <div class='input-form mb-1 @error('meta_keywords') has-error @enderror'>
                        ...
                        <input type='text' id='meta_keywords' name='meta_keywords'
                            class='form-control ' value='{{ $category->meta_keyword }}'
              ...
              <div class="col-lg-4">
                <div class="card p-4">
                    <img src="{{ url('') }}/{{ $category->image }}" alt="blogcategory" />
                </div>
              </div>
        </div>
    </div>
