...
class BlogDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            {
                return '<a href="' . url('/blog/' . $blog->slug) . '" target="_blank">' . $blog->name . '</a>';
            })
        ->editColumn('image', function (Blog $blog){
           return '<div class="media-aside align-self-center b-avatar badge-light-info rounded-circle">
            ...
            <img alt="" class="indeximg" src="' . url($blog->image) . '" width="50px>
            </span>
            </div>';
        })
     ...
     *
     * @param \App\Models\BlogDataTable $model
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('blog_category.name')->title('Category'),
