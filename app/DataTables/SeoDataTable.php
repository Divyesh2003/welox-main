...
class SeoDataTable extends DataTable
{
        ...
        return datatables()
            ...
            ->addColumn('action', function(Seo $seo) {
                return '<span style="display:flex">
                 <a href="' . route('admin.seo.edit', $seo->id) . '" class="flex items-center mr-3 text-theme-10" style="color:green;"> <svg class="h-6 w-6" <svg  width="20px"  height="20px"  viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  
                 <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" /> 
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" /></svg> </a> 
                 <form action="' . route('admin.seo.destroy', $seo->id) . '" method="POST" class="m-0">
                 ' . csrf_field() . '
                 ' . method_field("DELETE") . '
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('redirect')->title('Redirect'),
